 ...
 */
interface CollectionI18nConfig {
    /**
...
interface ResolvedCollection extends Omit<DefinedCollection, 'i18n'> {
    name: string;
    tableName: string;
    /**
 ...
 */
declare const I18N_SOURCE_HASH_FIELD: "_i18nSourceHash";
/**
 ...
 */
interface ManifestCollectionMeta {
    type: CollectionType;
    fields: Record<string, 'string' | 'number' | 'boolean' | 'date' | 'json'>;
    i18n?: CollectionI18nConfig;
    stemPrefix?: string;
}
type ManifestCollectionsMeta = Record<string, ManifestCollectionMeta>;
...
export { ContentFileExtension, ContentFileType, I18N_SOURCE_HASH_FIELD, _default as default, defineCollection, defineCollectionSource, defineContentConfig, defineTransformer, metaStandardSchema, pageStandardSchema, property, z };
export type { CacheEntry, Collection, CollectionI18nConfig, CollectionIndex, CollectionInfo, CollectionItemBase, CollectionQueryBuilder, CollectionQueryGroup, CollectionSource, CollectionType, Collections, ContentConfig, ContentFile, ContentI18nMeta, ContentLocaleEntry, ContentNavigationItem, ContentStandardSchemaV1, ContentTransformer, CustomCollectionSource, D1DatabaseConfig, DataCollection, DataCollectionItemBase, DatabaseAdapter, DatabaseAdapterFactory, DatabaseBindParams, DatabaseBindable, DefinedCollection, Draft07, Draft07Definition, Draft07DefinitionProperty, Draft07DefinitionPropertyAllOf, Draft07DefinitionPropertyAnyOf, Draft07DefinitionPropertyOneOf, DraftFile, DraftSyncData, DraftSyncFile, EditorOptions, FileAfterParseHook, FileBeforeParseHook, FileChangeMessagePayload, FileMessageData, FileMessageType, FileSelectMessagePayload, FileStatus, GitBasicAuth, GitRefType, GitRepositoryType, GitTokenAuth, LibSQLDatabaseConfig, LocalDevelopmentDatabase, Manifest, ManifestCollectionMeta, ManifestCollectionsMeta, MarkdownOptions, MarkdownPlugin, MarkdownRoot, MinimalElement, MinimalNode, MinimalText, MinimalTree, ModuleOptions, PGliteDatabaseConfig, PageCollection, PageCollectionItemBase, PageCollections, ParsedContentFile, ParsedContentv2, PostgreSQLDatabaseConfig, PreviewFile, PreviewOptions, PublicRuntimeConfig, QueryGroupFunction, ResolvedCollection, ResolvedCollectionSource, ResolvedCustomCollectionSource, RuntimeConfig, SQLOperator, SQLiteConnector, SqliteDatabaseConfig, SurroundOptions, TransformContentOptions, TransformedContent };
