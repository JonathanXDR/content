...
// @ts-ignore
export = _default;
export { ContentFileExtension, ContentFileType, I18N_SOURCE_HASH_FIELD, defineCollection, defineCollectionSource, defineContentConfig, defineTransformer, metaStandardSchema, pageStandardSchema, property, z };
